...
//orignal file name "(withcin)Amphibia.cpp"	
do {
menu = _getch();
if (menu == '2')
{
...
a=rand()%58; //change 58 (number) to the amount of episodes set/configured
...
/*
Amphibia Episode and Season DataBase for easy access
